                            ...
                            <tbody>
                                <?php foreach ($lists as $key => $list) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class=" btn btn-secondary btn-sm" href="<?= site_url('admin/client/edit/' . $list['id']) ?>"><i class="fas fa-edit"></i></a>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Are you sure you want to delete this client <strong><?= $list['client_name'] ?></strong></p>
                                                    </div>
                                                    <div class="modal-footer justify-content-between">
                                                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                        <a href="<?= site_url('admin/client/delete/' . $list['id']) ?>" class="btn btn-danger">Delete</a>
                                                    </div>
                                                </div>
                                                <!-- /.modal-content -->
                                            </div>
