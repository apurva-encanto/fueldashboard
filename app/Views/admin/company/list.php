                            ...
                            <tbody>
                                <?php foreach ($lists as $key => $list) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class=" btn btn-secondary btn-sm" href="<?= site_url('admin/company/edit/' . $list['id']) ?>"><i class="fas fa-edit"></i></a>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Are you sure you want to delete this Company <strong><?= $list['company_name'] ?></strong></p>
                                                    </div>
